        ...
        <CardContent className="pt-6">
          <div className="grid gap-4 md:grid-cols-3">
            <div className="space-y-2">
              ...
              <Select defaultValue="30days" onValueChange={(v)=>setRange(v as any)}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
            ...
            <div className="space-y-2">
              ...
              <Select defaultValue="all" onValueChange={(v)=>setTerritory(v)}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
            ...
            <div className="space-y-2">
              ...
              <Select defaultValue="all" onValueChange={(v)=>setRep(v)}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
          ...
          <Button className="mt-4 w-full" onClick={()=>{ /* filters already applied via state */ }}>Apply Filters</Button>
        </CardContent>
      </Card>
